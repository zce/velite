...
export interface WatchController {
  start(engine: BuildEngine, options: Options): Promise<Watcher>
}
 ...
 */
export const createWatchController = (logger: Logger = defaultLogger): WatchController => {
  const armWatcher = async (engine: BuildEngine, options: Options): Promise<Watcher> => {
